...
#else       /*LV_MEM_CUSTOM*/
#  define LV_MEM_CUSTOM_INCLUDE <Library/MemoryAllocationLib.h>  //<stdlib.h>   /*Header for the dynamic memory function*/
#  define LV_MEM_CUSTOM_ALLOC   AllocatePool // malloc       /*Wrapper to malloc*/
#  define LV_MEM_CUSTOM_FREE    FreePool         // free         /*Wrapper to free*/
#endif     /*LV_MEM_CUSTOM*/
